...
- **Demo:** `python -m myers review examples/sample.diff`
- **Also:** `python -m myers eval` (baseline precision/recall on the golden set) · `pytest`
...
- **Demo:** `python -m myers review examples/sample.diff --mode llm`
...
- **Demo:** `python -m myers review examples/sample.diff --mode specialists`
...
- **Demo:** `python -m myers eval --report`  ·  `python -m myers trace <review_id>`
